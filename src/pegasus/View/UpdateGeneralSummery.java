 ...
 * @author Chamil123
 */
public class UpdateGeneralSummery extends javax.swing.JDialog {
    ...
    double noCommsion;
    double lessCommsion;
    private Integer updateGeneralSummeryId;

    /**
     * Creates new form NewSummery
     */
    public UpdateGeneralSummery(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        jTextField11.setText("");
    ...
    private void initComponents() {
        ...
        setTitle("Update General Summery");
        ...
        jLabel1.setText("General name :");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 80, 20));

        jLabel2.setText("           Date :");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 80, 20));
        ...
        jLabel3.setText("General id :");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 60, 20));
        ...
        jPanel1.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(319, 10, 120, -1));
...
//        jTextField1.grabFocus();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            int searchExcisting = General_summeryController.searchsummeryByDateAndId(stringdate1, jTextField3.getText());
            if (searchExcisting == 1) {
                ...
                General_Summery generalSummery = new General_Summery(updateGeneralSummeryId,
                        stringdate1,
                ...
                int isAddedgensum = General_summeryController.updateGeneral(generalSummery);
                int maxId = 0;
                ...
                for (int i = 0; i < rowCount; i++) {
                    ...
                    isDelete = GeneralSummeryLineController.deleteGeneralSummeryLine(stringdate1, "" + updateGeneralSummeryId);
                }
                String summerynames;
                double fullCollection;
                double payment;
                ...
                for (int i = 0; i < rowCount; i++) {
                    ...
                    GeneralSummeryLine generalsummeryLine = new GeneralSummeryLine(null, summerynames, fullCollection, payment, stringdate1, maxId);
...
//////
                 ...
                 //   JasperManager.printReport(jasperPrint, true);
                    ...
                    Logger.getLogger(UpdateGeneralSummery.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "surrently not in the database");
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (searchExcisting == 1) {
                ...
                JOptionPane.showMessageDialog(null, "successfuly saved general " + jComboBox1.getSelectedItem());
            } else {
                JOptionPane.showMessageDialog(null, jComboBox1.getSelectedItem() + " is currently not added");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(UpdateGeneralSummery.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            jTextField3.setText("" + accountId);

            int searchExcisting = General_summeryController.searchsummeryByDateAndId(stringdate1, "" + accountId);
            if (searchExcisting == 1) {

                General_Summery gensummery = General_summeryController.searchGeneralsummeryById(stringdate1, account.getAccount_id());
                updateGeneralSummeryId = gensummery.getGeneralSummery_id();
                commsion = account.getAccount_com();
                noCommsion = account.getAccount_noCom();
                lessCommsion = account.getAccount_lessCom();

                jTextField3.setText("" + accountId);

                jTextField7.setText("" + gensummery.getGeneralSummery_cash());
                jTextField28.setText("" + gensummery.getGeneralSummery_excess());
                jTextField8.setText("" + gensummery.getGeneralSummery_pd());
                jTextField4.setText("" + gensummery.getGeneralSummery_lessComAmmount());
                jTextField6.setText("" + gensummery.getGeneralSummery_noComAmmount());

                jTextField15.setText("" + gensummery.getGeneralSummery_lcnc());
                jTextField16.setText("" + account.getAccount_paperCash());
                jTextField18.setText("" + account.getAccount_loan());
                jTextField20.setText("" + gensummery.getGeneralSummery_pd());

                jTextField17.setText("" + account.getAccount_exp());
                jTextField19.setText("" + gensummery.getGeneralSummery_excess());
                jTextField21.setText("" + gensummery.getGeneralSummery_cash());
                ...
                List<Summery> summery = SummeryController.searchsummeryByDateAndAccoundID(stringdate1, accountId);
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.setRowCount(0);
                double totalFullCollection = 0;
                double totalPayment = 0;
                for (int i = 0; i < summery.size(); i++) {
                    Vector v = new Vector();
                    totalFullCollection += summery.get(i).getSummery_fc();
                ...
                double compay = totalFullCollection * commsion;
                jTextField13.setText("" + totalPayment);
                jTextField14.setText("" + compay);
                jTextField12.setText("" + totalFullCollection);

                loadTotalValues();
                jLabel30.setText("" + jTable1.getRowCount());
            } else {
                JOptionPane.showMessageDialog(null, name + " normal sammery not added");
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.setRowCount(0);
                jTextField12.setText("0");
                jTextField15.setText("0");
...
//                    JasperManager.printReport(jasperPrint, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateGeneralSummery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
