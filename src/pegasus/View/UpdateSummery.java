 ...
 * @author Chamil123
 */
public class UpdateSummery extends javax.swing.JDialog {
    ...
    double noCommsion;
    double lessCommsion;
    private Integer updateSummeryId;

    /**
     * Creates new form NewSummery
     */
    public UpdateSummery(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 40, 20));
        ...
        jPanel1.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(311, 10, 130, -1));
        ...
        if (evt.getKeyCode() == 10) {
            try {
                ...
                if (searchExcisting == 0) {
                    jTable10.setVisible(false);
                    jScrollPane6.setVisible(false);
                    JOptionPane.showMessageDialog(null, jTextField9.getText() + " is not added");
                    ...
                    Summery summery = SummeryController.searchsummeryById(stringdate1, id);
                    Center center = CenterController.searchCenterById(id);
                    updateSummeryId = summery.getSummery_id();
                    commsion = center.getCenter_com();
                    noCommsion = center.getCenter_noCom();
                    lessCommsion = center.getCenter_lessCom();

                    jTextField3.setText(id);
                    jTextField5.setText("" + summery.getSummery_fc());
                    jTextField7.setText("" + summery.getSummery_cash());
                    jTextField28.setText("" + summery.getSummery_excess());
                    jTextField8.setText("" + summery.getSummery_pd());
                    jTextField4.setText("" + summery.getSummery_lessComAmount());
                    jTextField6.setText("" + summery.getSummery_noComAmount());

                    jTextField12.setText("" + summery.getSummery_fc());
                    jTextField15.setText("" + summery.getSummery_lcnc());
                    jTextField16.setText("" + center.getCenter_paperCash());
                    jTextField18.setText("" + center.getCenter_loan());
                    jTextField20.setText("" + summery.getSummery_pd());

                    jTextField13.setText("" + summery.getSummery_slippaytot());
                    jTextField14.setText("" + summery.getSummery_compay());
                    jTextField17.setText("" + center.getCenter_exp());
                    jTextField19.setText("" + summery.getSummery_excess());
                    jTextField21.setText("" + summery.getSummery_cash());

//                    Summery_lineController summerylineController = remoteFactory.getSummery_lineController();
                    List<Summery_line> sumline = Summery_lineController.getSummeryLinesByDateAndId(stringdate1, id);

                    DefaultTableModel dtm2 = (DefaultTableModel) jTable1.getModel();

                    for (int i = 0; i < sumline.size(); i++) {
                        Vector v = new Vector();
                        v.add(sumline.get(i).getSummery_line_chitNumber());
                        v.add(sumline.get(i).getSummery_line_investment());
                        v.add(sumline.get(i).getSummery_line_payment());
                        dtm2.addRow(v);
                    }
    ...
    private void jTextField9KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField9KeyReleased
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(UpdateSummery.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            int searchExcisting = SummeryController.searchsummeryByDateAndId(stringdate1, jTextField3.getText());
            if (searchExcisting != 0) {
                ...
                Summery summery = new Summery(updateSummeryId, stringdate1,
                ...
                try {
                    int isUpdate = SummeryController.updatesummery(summery);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(UpdateSummery.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(UpdateSummery.class.getName()).log(Level.SEVERE, null, ex);
                ...
                try {
                    ...
                    for (int i = 0; i < rowCount; i++) {
                        isDelete = Summery_lineController.deleteSummery_line(stringdate1, Integer.parseInt(jTextField3.getText()));
                    ...
                    for (int i = 0; i < rowCount; i++) {
                        ...
                        summeryLine = new Summery_line(null, chitNumber, investment, payment, stringdate1, Integer.parseInt(jTextField3.getText()));
...
//                        JasperManager.printReport(jasperPrint, false);
                        ...
                        if (jTextField9.getText().equals("JSP")) {
                            ...
                            JasperExportManager.exportReportToPdfFile(jasperPrint, "C:\\pegasusReports/" + pdfName + "corrections.pdf");
...
//                        JasperManager.printReport(jasperPrint, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSummery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateSummery dialog = new UpdateSummery(new javax.swing.JFrame(), true);
